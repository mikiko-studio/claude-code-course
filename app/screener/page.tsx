...
const UNIVERSE_INFO: Record<Market, Record<string, [string, string][]>> = {
  ...
  jp: {
    'Technology': [
      ...
      ['7741.T','HOYA'],['6920.T','レーザーテック'],['6146.T','ディスコ'],['6098.T','リクルートHD'],
    ],
    'Consumer Discretionary': [
    ...
    'Financials': [
      ...
      ['8058.T','三菱商事'],['8031.T','三井物産'],['8001.T','伊藤忠'],['8053.T','住友商事'],['8002.T','丸紅'],
    ],
    'Real Estate': [
      ['1925.T','大和ハウス工業'],['8801.T','三井不動産'],
    ],
    'Communication Services': [
    ...
    'Healthcare': [
      ...
      ['4568.T','第一三共'],['4506.T','住友ファーマ'],['7733.T','オリンパス'],
    ],
    'Consumer Staples': [
